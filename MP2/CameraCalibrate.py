...
image_dir = "XXX"                                         # Choose images1 or images2
...
for fname in image_filenames:
    ...
    ret, corners = cv2.findChessXXX(img, num_corners, cv2.CALIB_CB_NORMALIZE_IMAGE)
    ...
    if ret:
        ...
        corners2 = cv2.cornerSubPix(XXX, XXX, (11, 11), (-1, -1), criteria)
