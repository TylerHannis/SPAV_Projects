...
def main(_argv):
    ...
    if FLAGS.tfrecord:
        ...
        for image in images:
            ...
            raw_image_names.append(os.path.basename(image))
    num = 0    
    for raw_img in raw_images:
        ...
        out_file = 'detection_' + raw_image_names[num]
        cv2.imwrite(FLAGS.output + out_file, img)
        print('output saved to: {}'.format(FLAGS.output + out_file))
        num += 1
